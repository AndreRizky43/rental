...
<script>
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		if (showAlert === "1") {
			showBootstrapAlert('success', 'SUKSES', `Berhasil Menambahkan Pelanggan ${namaPelanggan}`);
		} else if (showAlert === "2") {
			showBootstrapAlert('success', 'SUKSES', `Berhasil Mengedit Pelanggan ${namaPelanggan}`);
		} else if (showAlert === "3") {
			showBootstrapAlert('success', 'SUKSES', `Berhasil Menghapus Pelanggan ${namaPelanggan}`);
		} 
