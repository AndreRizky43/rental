...
<form method="post" class="form-horizontal" action="tambahsesiproses.php">
    ...
    <div class="form-group">
        <label for="konsol" class="col-sm-3 control-label">Komputer </label>
        <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="Konsol" name="konsol" value="<?php echo $d['NamaKonsol']; ?>" disabled>
        </div>
    </div>
    <div class="form-group">
