								...
								<div class="box">
									<div class="box-header">
												...
												<div class="modal-content">
													<form id="editForm" action="editsesiproses.php" method="post">
														...
														<div class="modal-body">
															...
															<div class="form-group">
																<label for="editTelevisi">Komputer :</label>
										...
										<div class="box-body">
															...
															<tr>
																...
																<td>
																	...
																	if ($d['hargabayar'] !== null) {
																		// Format the hargabayar in Indonesian Rupiah format
											...
											<p style="color: red; font-weight: bolder;">&ast; Halaman ini memuat setiap 1 menit sekali!</p>
										</div>
										<a href="hancurkansemuanya.php" type="button" class="btn btn-warning glyphicon glyphicon-trash" title="Hapus Semua Sesi (Hati-Hati)">
										</a>
										<!-- /.box-body -->
									</div>
								</div>
...
<script>
	$(document).ready(function () {
		$('#tambahSesiModal').on('show.bs.modal', function (event) {
			...
			var idkonsol = button.data('idkonsol'); 
			var modal = $(this);
			modal.find('.modal-body').load('tambahsesineo.php?idkonsol=' + idkonsol);
		});
-
