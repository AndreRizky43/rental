...
$namaPelangganQuery = mysqli_query($koneksi, "SELECT NamaPelanggan FROM pelanggan WHERE IDPelanggan IN (SELECT IDPelanggan FROM sesi WHERE IDSesi='$id')");
...
header("location: indexop.php?showAlert=2&namaPelanggan=" . urlencode($namaPelanggan));
?>